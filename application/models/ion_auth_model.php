...
echo $password;exit();
	...
	**/
	...
	public function set_session($user)
	{
        ...
        $query = $this->db->query("select A.*,B.* from groups A
       ...
       $session_type = array('name'=> $names->name);
       $this->session->set_userdata($session_type);
	...
	**/
	...
	{
		$salt = $this->store_salt ? $this->salt() : FALSE;
		return $this->hash_password($pass, $salt);
	}
}
