  ...
  <div class="container">
    ...
    <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
      <ul class="nav navbar-nav">
      		<?php
				$tfacility = $this->db->query("select * from tfacility");
				foreach($tfacility->result() as $facility)
				{
			?>
        			<li<?php if($facility->facility_iD == $this->uri->segment(3)) { ?> class="active" <?php } ?> > <a href="<?php echo base_url();?>student/calendar/<?php echo $facility->facility_iD;?>"><?php echo $facility->Facility_name; ?></a></li>
            <?php
				}
			?>
            	<li><a href="<?php echo base_url();?>student/my_reservation" >My Reserve Room</a></li>
      </ul>
    </nav>
  </div>
</div>
