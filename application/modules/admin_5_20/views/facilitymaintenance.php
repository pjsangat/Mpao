...
<div class="mygrid-wrapper-div" >
  ...
  <div class="panel panel-primary">
    ...
    <label>Gender type</label></br>
          <label class="radio-inline">
              <input type="radio" name="Gender" value="female">is Female?
          </label>
          <label class="radio-inline">
             <input type="radio" name="Gender" value="male">is Male?
          </label>
          <label class="radio-inline">
  ...
  <div class="col-lg-2"></br>
    ...
    <div class="col-lg-3">
        <label>Max Number of Female</label></br><input type="number" class="form-control" placeholder="Max Number of Female" maxlength="11" name="Max_female_person" value="0" required>
        </br></div>
        <div class="col-lg-3">
          <label>Max Number of Male</label><input type="number" class="form-control" placeholder="Max Number of Male" maxlength="11" name="Max_male_person" value="0" required>
        </div>
        <div class="col-lg-1">
          <input type="hidden" class="form-control" placeholder="No. Person Maximum" >
        </div>
