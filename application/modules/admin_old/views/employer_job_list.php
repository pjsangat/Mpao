...
<div class="main_content">
  ...
  <h3 class="title"><span class="pull-left">Employer Job List [<?php echo $company['company_name']; ?>]</span></h3>
        ...
        <div class="featured-item">
          <div class="row">
            ...
            <p>
            	...
            	<a href="#" onclick="__confirm('<?php echo $emp->id; ?>','Delete Job Posting?','company_joblisting'); return false;">Delete</a> | <a href="<?php echo base_url().''.$emp->username;?>" target="_blank">Profile</a> | <a href="<?php echo base_url();?>admin/employer_job/<?php echo $emp->userid; ?>">Job Posted</a> 
            </p>
